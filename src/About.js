  ...
  return (
      <div className="about-container">
        ...
        <div className="about-section">
          ...
          <p className="section-paragraph">
            פרויקט ישראמוג’י מבוסס על תוכן שנאסף מתוך עשרות אלפי פוסטים שהועלו בישראל ברשת החברתית X (טוויטר) בשנים 2023-2024. מתוך התוכן, חולצו נתונים בנוגע לשימוש באימוג’ים בישראל.
          </p>
        </div>
